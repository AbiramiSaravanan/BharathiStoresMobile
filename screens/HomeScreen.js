...
import { Container, Content, List, ListItem, Left, Body, Thumbnail,Right,Header,Icon} from 'native-base';
import Slideshow from 'react-native-slideshow';
import { SearchBar } from 'react-native-elements';
import {displayCategories} from '../project11/CustomerRedux/actions/categoryDisplayActions';
...
class HomeScreen extends React.Component {
  ...
  async componentDidMount(){
    ...
    const tok = await AsyncStorage.getItem("jwtToken")
    console.log("tokkkkkkkkkkkkk",tok)
  }
    ...
    return (
      ...
      />
        ...
        onPositionChanged={position => this.setState({ position })} />
          ...
          <List>
            <ListItem avatar onPress={() =>this.handleRoute(p._id)}>
              <Left>
              ...
              <Body>
                <Text title="Home" style={{textAlign:'center',fontWeight:'bold'}}>{p.categoryname}</Text>
                <Text note style={{textAlign:'center',padding:'3%'}}>Rice,Flour,Dal,oils,Ghee,Sugar,Spices,Masala,Nuts,etc</Text>
