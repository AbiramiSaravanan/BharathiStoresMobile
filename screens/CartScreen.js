...
import {getCart} from '../project11/CustomerRedux/actions/cartDisplayActions';
import { Avatar, Card, Title, Paragraph , Divider } from 'react-native-paper';
import Icon from 'react-native-vector-icons/Ionicons'
import { Footer } from 'native-base';

import {addToCart,cleanCart} from '../project11/CustomerRedux/actions/cartDisplayActions';

import {placeOrder} from '../project11/CustomerRedux/actions/orderDisplayActions';
...
handleAddChange = async (productid, sp) => {
  ...
  submitorder = async () => {
    ...
    // if(tok){
    // await this.props.placeOrder(this.props.displaycart.cart, tok)
  ...
  // if(this.state.reload) return()
    render() {
      ...
      console.log( this.props.displaycart)
        return (
            <View style={{height:hp('80%'), backgroundColor:'#f2efef'}}>
