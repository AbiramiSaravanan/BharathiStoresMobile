...
import {View,StyleSheet,SafeAreaView,ScrollView,Dimensions,TouchableOpacity,Text, AsyncStorage} from "react-native";
import { Container, Content, List, ListItem, Left, Body, Thumbnail,Button} from 'native-base';
import {Card} from 'react-native-elements'
import Icon from 'react-native-vector-icons/Ionicons' 
import {  widthPercentageToDP as wp, heightPercentageToDP as hp} from 'react-native-responsive-screen'
import {displaySubCategories, subcategory_product_replace} from '../project11/CustomerRedux/actions/subCategoryDisplayActions';
import {displayProducts} from '../project11/CustomerRedux/actions/productDisplayActions';
import {addToCart, getCart} from '../project11/CustomerRedux/actions/cartDisplayActions';
